$(function() {
	$(".g-form").submit(function (event) {
		...
		let appLink = "https://script.google.com/macros/s/AKfycbySsPwc_jEB4SDg3BIUdnXqNV0hw0EBsdCkPD74pJFaJwixjZMGRAfd4BaAGHw-jenx/exec";

		// Сообщение при успешной отправке данных
		let successRespond = 'Заказ успешно оформлен.';
		// Сообщение при ошибке в отправке данных
		let errorRespond = 'Не удалось оформить заказ.';
		...
		let submitButton = $(this).find('.button_2');
